...
export default function ToptalBadge() {
  return (
    ...
    >
      ...
      >
        <Box component="svg" viewBox="0 0 60 17" sx={{ width: 64, height: "auto" }}>
          <path
        ...
        <Typography sx={{ m: 0, fontSize: 19, fontWeight: 700, lineHeight: 1 }}>
          TOP 3% TALENT
        </Typography>

        <Box sx={{ width: 120, height: 1, bgcolor: "#25a9ef" }} />

        <Typography sx={{ fontSize: 16, mb: "-6px" }}>Vetted by</Typography>

        <Box component="svg" viewBox="0 0 108 30" sx={{ width: 100, height: "auto" }}>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <Link
          href="https://www.toptal.com/developers/resume/dalton-james-neely#ZZy8Kx"
          target="_blank"
          rel="noreferrer"
          underline="always"
          sx={{
